<?php
  ...
  if (isset($_SESSION['nisnip'])) {
    ...
    // Hapus data jika ada parameter id_kategori yang diterima
        ...
        <div class="card top-selling overflow-auto">
          ...
          <div class="card-body pb-0">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="add-data">
                <a href="kategori-tambah.php"><button class="badge bg-success">Tambah Data <i class="ri-add-line"></i></button></a>
              </div>
            </div>
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                echo "<td>";
                echo "<a href='kategori-edit.php?id_kategori=" . $row['id_kategori'] . "'><button class='badge bg-warning'>Edit <i class='ri-pencil-line'></i></button></a>";
                echo "<a href='tables-data-kategori.php?id_kategori=" . $row['id_kategori'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">";
