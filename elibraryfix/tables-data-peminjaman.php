<?php
  ...
  if (isset($_SESSION['nisnip'])) {
    ...
    // Hapus data jika ada parameter id_peminjaman yang diterima
          ...
          <div class="card-body pb-0">
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                echo "<td>";
                echo "<a href='peminjaman-edit.php?id_peminjaman=" . $row['id_peminjaman'] . "'><button class='badge bg-warning'>Edit <i class='ri-pencil-line'></i></button></a>";
                echo "<a href='tables-data-peminjaman.php?id_peminjaman=" . $row['id_peminjaman'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">";
