<?php
  ...
  if (isset($_SESSION['nisnip'])) {
    ...
    // Hapus data jika ada parameter id_admin yang diterima
    if(isset($_GET['id_admin'])) {
      $id_admin = $_GET['id_admin'];
      
      // Hapus data dari table
      $query = "DELETE from akunadmin WHERE id_admin='$id_admin'";
          ...
          <div class="card-body pb-0">
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                echo "<td>";
                echo "<a href='admin-edit.php?id_admin=" . $row['id_admin'] . "'><button class='badge bg-warning'>Edit <i class='ri-pencil-line'></i></button></a>";
                echo "<a href='tables-data-admin.php?id_admin=" . $row['id_admin'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">";
