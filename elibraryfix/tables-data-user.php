<?php
  ...
  if (isset($_SESSION['nisnip'])) {
    ...
    // Hapus data jika ada parameter id_user yang diterima
    if(isset($_GET['id_user'])) {
      $id_user = $_GET['id_user'];
      
      // Hapus data dari table
      $query = "DELETE from akunuser WHERE id_user='$id_user'";
          ...
          <div class="card-body pb-0">
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                echo "<td>";
                echo "<a href='user-edit.php?id_user=" . $row['id_user'] . "'><button class='badge bg-warning'>Edit <i class='ri-pencil-line'></i></button></a>";
                echo "<a href='tables-data-user.php?id_user=" . $row['id_user'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">";
