<?php
  ...
  if (isset($_POST['tambah'])) {
    ...
    if ($id_buku && $id_kategori && $judul && $penulis && $penerbit && $tahun_terbit && $jumlah_halaman && $stok && $deskripsi && $foto) {
        $dir = "Gambar/$foto";
        move_uploaded_file($tmp_file, $dir);
        $sql = "INSERT INTO buku(id_buku, id_kategori, judul, penulis, penerbit, tahun_terbit, jumlah_halaman, stok, deskripsi, foto) 
        VALUES ('$id_buku', '$id_kategori', '$judul', '$penulis', '$penerbit', '$tahun_terbit', '$jumlah_halaman', '$stok', '$deskripsi', '$foto')";
        mysqli_query($conn, $sql) or die(mysqli_error($conn));
        header("Location: tables-data-buku.php");
        exit();
    } else {
        echo "Gagal upload!<br>";
        echo "<a href='buku-tambah.php'>Upload ulang</a>";
        exit();
    }
        ...
        <div class="card">
            ...
            <form method="POST" enctype = "multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" min="1" class="form-control" name="jumlah_halaman">
                    </div>
                </div>
