<?php
  ...
  if (isset($_GET['id_kategori'])) {
    ...
    // Proses pengeditan data kategori
    if (isset($_POST['simpan'])) {
      $id_kategori = $_POST['id_kategori'];
      $nama_kategori = $_POST['nama_kategori'];
  
      $updateQuery = "UPDATE kategori SET id_kategori = '$id_kategori', nama_kategori = '$nama_kategori' WHERE id_kategori = '$id_kategori'";
        ...
        <div class="card">
            ...
            <form method="POST">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="id_kategori" value="<?php echo $kategori['id_kategori']; ?>" readonly>
                    </div>
                </div>
