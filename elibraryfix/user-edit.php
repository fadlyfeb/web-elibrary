<?php
  ...
  if (isset($_GET['id_user'])) {
    ...
    $sql = "SELECT * FROM akunuser WHERE id_user = '$id_user'";
    $result = mysqli_query($conn, $sql);
    ...
    if (isset($_POST['simpan'])) {
      ...
      $updateQuery = "UPDATE akunuser SET id_user = '$id_user', nama = '$nama', nis = '$nis', jenis_kelamin = '$jenis_kelamin', tanggal_lahir = '$tanggal_lahir', nomor_hp = '$nomor_hp', alamat = '$alamat', pass = '$pass' WHERE id_user = '$id_user'";
      if (mysqli_query($conn, $updateQuery)) {  
        header("Location: tables-data-user.php");
        exit();
      } else {
    ...
    <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="tables-data-user.php">Data User</a></li>
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" min="0" class="form-control" name="nis" value="<?php echo $user['nis']; ?>">
                    </div>
                </div>
                ...
                <fieldset class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelaminL" value="Laki-Laki" <?php if ($user['jenis_kelamin'] == 'Laki-Laki') echo 'checked'; ?>>
                            <label class="form-check-label">Laki-Laki</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelaminP" value="Perempuan" <?php if ($user['jenis_kelamin'] == 'Perempuan') echo 'checked'; ?>>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" min="0" class="form-control" name="nomor_hp" value="<?php echo $user['nomor_hp']; ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" style="height: 100px" name="alamat"><?php echo $user['alamat']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-sm-10">
                    ...
                    <a href="tables-data-user.php" class="btn btn-danger">Cancel</a>
                </div>
